...
export const CATEGORIES: Category[] = [
  ...
  },
  {
    ...
    intro: [
      "A PDF eszközeinkkel szerverfeltöltés nélkül kezelheted a dokumentumaidat: összefűzhetsz több PDF-et, kiolvashatod az oldalszámot, vagy a dedikált szétbontó eszközzel különálló oldalakra oszthatod a fájlt. A feldolgozás teljes egészében a böngésződben történik a pdf-lib és pdfjs-dist könyvtárak segítségével.",
  ...
  },
  {
    ...
    description: "Adateszközök a böngésződben: CSV, JSON és TSV konvertálás, adattisztítás, oszlop- és sorszűrés, fejléc-átnevezés. Minden helyben fut – ingyenes és privát.",
  ...
  },
  {
    ...
    description: "Markdown eszközök a böngészőben: alakítsd a Markdown szöveget HTML-lé, és tekintsd meg élő előnézetben, valós időben. Szerver nélkül – ingyenes és privát.",
  ...
  },
  {
    ...
    description: "HTML eszközök a böngészőben: alakítsd a HTML kódot tiszta szöveggé a tag-ek eltávolításával, vagy minifikáld a kódot. Szerver nélkül – ingyenes és privát.",
  ...
  },
  {
    ...
    description: "Konvertáld és tekintsd meg Excel (XLSX) táblázataidat a böngészőben: XLSX ↔ CSV és JSON átalakítás, előnézet, szerverfeltöltés nélkül. Ingyenes és privát.",
  ...
  },
  {
    ...
    description: "Fájlkezelő eszközök a böngésződben: ZIP archívum készítése és kibontása, hash-ellenőrzés (SHA, MD5) és fájl-információk. Szerverfeltöltés nélkül – ingyenes.",
  ...
  // ═══ SZÍNEK (HU+RO közös kategória) ══════════════════════════════
  {
    ...
    description: "Színeszközök a böngészőben: színkonverter (HEX, RGB, HSL), WCAG kontraszt-ellenőrző, CSS gradiens generátor, színharmónia és színvakság-szimulátor – ingyenes.",
...
const rawTools: Tool[] = [
  ...
  { slug: "90-fokos-forgatas", category: "kep", title: "Kép 90°-os forgatás | Gyors online eszköz", h1: "Kép 90°-os forgatása", description: "Forgasd el a képeket 90 fokkal balra vagy jobbra egy kattintással, akár kötegelt feldolgozással. Minden a böngésződben történik – ingyenes, gyors és privát.", keywords: ["90 fok forgatás", "rotate 90 online", "kép 90 fokos forgatás", "quick rotate image"], status: "active", component: "NinetyDegRotateTool", related: ["forgatas", "tukrozes"], updatedAt: "2026-02-23", launchedAt: "2026-02-23", faq: [] },
  ...
  // ═══ KÉP – Batch D (HU+RO) ══════════════════════════════
  {
    slug: "placeholder-kep", category: "kep",
    title: "Placeholder kép generátor online – helykitöltő kép | Ingyenes",
    h1: "Placeholder kép generátor",
    description: "Egyszínű helykitöltő (placeholder) kép generálása tetszőleges mérettel, felirattal és színnel. PNG letöltés, méret-sablonokkal. Böngészőben.",
    keywords: ["placeholder kép", "helykitöltő kép", "dummy image", "placeholder generátor", "teszt kép", "mockup kép"],
    status: "active", component: "PlaceholderKep",
    updatedAt: "2026-07-06", launchedAt: "2026-07-06",
    related: ["kep-diff", "favicon-generator", "atmeretezes"], faq: [],
  },
  {
    slug: "kep-ascii", category: "kep",
    title: "Kép → ASCII art online – szöveges kép | Ingyenes",
    h1: "Kép → ASCII art",
    description: "Kép átalakítása ASCII (szöveges) művészetté a fényerő alapján. Állítható szélesség, karakterkészlet, invertálás. Másolható, letölthető. Böngészőben.",
    keywords: ["ascii art", "kép ascii", "image to ascii", "ascii generátor", "szöveges kép", "ascii art készítő"],
    status: "active", component: "KepAscii",
    updatedAt: "2026-07-06", launchedAt: "2026-07-06",
    related: ["mem-generator", "kep-diff", "pixelates"], faq: [],
  },
  {
    slug: "mem-generator", category: "kep",
    title: "Mémgenerátor online – felirat képre | Ingyenes",
    h1: "Mémgenerátor (felirat képre)",
    description: "Felső és alsó felirat hozzáadása képhez klasszikus Impact-stílusban. Betűméret-állítás, PNG letöltés. Böngészőben, feltöltés nélkül.",
    keywords: ["mémgenerátor", "meme generator", "felirat képre", "mém készítő", "szöveg képre", "impact felirat"],
    status: "active", component: "MemGenerator",
    updatedAt: "2026-07-06", launchedAt: "2026-07-06",
    related: ["kep-ascii", "vizjel", "keret-padding"], faq: [],
  },
  {
    slug: "kep-diff", category: "kep",
    title: "Kép-összehasonlító online – két kép különbsége | Ingyenes",
    h1: "Kép-összehasonlító (diff)",
    description: "Két kép pixel-szintű összehasonlítása: az eltérések piros kiemeléssel, a különböző pixelek százalékával. Érzékenységi küszöb. Böngészőben, privát.",
    keywords: ["kép összehasonlítás", "image diff", "kép különbség", "két kép összevetése", "pixel diff", "image compare"],
    status: "active", component: "KepDiff",
    updatedAt: "2026-07-06", launchedAt: "2026-07-06",
    related: ["placeholder-kep", "kep-ascii", "metadata-megjelenites"], faq: [],
  },
  {
    slug: "qr-olvaso", category: "kep",
    title: "QR-kód olvasó online – QR dekódolás képből | Ingyenes",
    h1: "QR-kód olvasó",
    description: "QR-kód dekódolása feltöltött képből – a kód tartalma azonnal olvasható, másolható. A böngésződben fut, a kép nem kerül szerverre.",
    keywords: ["qr olvasó", "qr kód olvasó", "qr decode", "qr scanner", "qr kód beolvasás", "qr reader online"],
    status: "active", component: "QrOlvaso",
    updatedAt: "2026-07-06", launchedAt: "2026-07-06",
    related: ["kep-diff", "metadata-megjelenites", "kep-base64"], faq: [],
  },
  {
    slug: "kerek-vagas", category: "kep",
    title: "Kör alakú kivágás online – kerek avatar | Ingyenes",
    h1: "Kör alakú kivágás (avatar)",
    description: "Kép kör alakúra vágása profilképnek: átlátszó hátterű PNG, állítható méret és keret. A böngésződben, feltöltés nélkül.",
    keywords: ["kör kivágás", "kerek avatar", "profilkép kör", "kör alakú kép", "avatar generátor", "circle crop"],
    status: "active", component: "KerekVagas",
    updatedAt: "2026-07-06", launchedAt: "2026-07-06",
    related: ["levagas", "automatikus-vagas", "keret-padding"], faq: [],
  },

  // ═══ PDF ════════════════════════════════════════════════
  { slug: "osszeillesztes", category: "pdf", title: "PDF összefűzés online | Merge PDF ingyenes", h1: "PDF összefűzés", description: "Több PDF összefűzése egyetlen dokumentummá drag&drop sorrenddel, böngészőben. Szervermentes, privát, korlátlan méret.", keywords: ["pdf merge", "pdf összefűzés", "pdf összefűző", "pdf összeillesztés online", "merge pdf ingyenes", "pdf egyesítés"], status: "active", component: "PdfMergeTool", related: ["szetbontas", "oldalak-kivalasztasa", "oldalak-sorrendje"], updatedAt: "2026-08-17", launchedAt: "2026-02-23", faq: [{ q: "Feltöltődnek a PDF-jeim szerverre?", a: "Nem – minden feldolgozás a böngésződben történik." }] },
  { slug: "szetbontas", category: "pdf", title: "PDF szétbontása és szétválasztása oldalakra | Split PDF", h1: "PDF szétbontása", description: "PDF szétbontása, szétválasztása és szétszedése különálló oldalakra vagy tartományokra, ZIP letöltéssel. Böngészőben, szervermentes, ingyenes.", keywords: ["pdf split", "pdf szétbontás", "pdf szétválasztó", "pdf szétszedő", "pdf szétbontó", "pdf daraboló", "pdf darabolás", "pdf oldalak szétválasztás", "split pdf online ingyenes"], status: "active", component: "PdfSplitTool", related: ["osszeillesztes", "oldalak-kivalasztasa"], updatedAt: "2026-08-17", launchedAt: "2026-02-23", faq: [] },
  { slug: "oldalak-kivalasztasa", category: "pdf", title: "PDF oldalak kiválasztása és kinyerése online", h1: "PDF oldalak kiválasztása", description: "Emelj ki tetszőleges oldalakat egy PDF-ből oldalszám-tartományokkal, vizuális előnézettel. A feldolgozás a böngésződben fut – ingyenes és szervermentes.", keywords: ["pdf extract pages", "pdf oldalak kinyerés", "pdf oldal kiválasztás", "pdf page extract online"], status: "active", component: "PdfOldalakKivalasztasaTool", related: ["szetbontas", "oldalak-sorrendje", "oldalak-torlese"], updatedAt: "2026-02-23", launchedAt: "2026-02-23", faq: [] },
  { slug: "oldalak-sorrendje", category: "pdf", title: "PDF oldalak átrendezése online | Reorder", h1: "PDF oldalak átrendezése", description: "Rendezd át a PDF oldalait drag & drop mozdulatokkal, bélyegkép-előnézettel, majd töltsd le az új sorrendet. A böngészőben fut – ingyenes és szervermentes.", keywords: ["pdf reorder", "pdf pages order", "pdf oldalak rendezés", "pdf sorrend változtatás"], status: "active", component: "PdfOldalakSorrendjeTool", related: ["oldalak-kivalasztasa", "osszeillesztes"], updatedAt: "2026-02-23", launchedAt: "2026-02-23", faq: [] },
  ...
  { slug: "oldalak-torlese", category: "pdf", title: "PDF oldalak törlése online | Remove pages", h1: "PDF oldalak törlése", description: "Törölj megadott oldalakat egy PDF dokumentumból vizuális előnézettel, majd töltsd le a rövidebb fájlt. A böngésződben fut – ingyenes és szervermentes eszköz.", keywords: ["pdf delete pages", "pdf oldal törlés", "pdf remove pages", "pdf oldal eltávolítás online"], status: "active", component: "PdfOldalakTorleseTool", related: ["oldalak-kivalasztasa", "szetbontas"], updatedAt: "2026-02-23", launchedAt: "2026-02-23", faq: [] },
  ...
  { slug: "kepek-pdfbe", category: "pdf", title: "Képek PDF-be összefűzése online | Image to PDF", h1: "Képek → PDF konvertálás", description: "Fűzz JPG és PNG képeket egyetlen PDF dokumentummá a böngészőben: oldalméret és drag&drop sorrend állítható. Semmi nem kerül szerverre – ingyenes és privát.", keywords: ["image to pdf", "jpg pdf", "kép pdf konvertálás", "képek pdf-be", "jpg to pdf online ingyenes"], status: "active", component: "KepekPdfbeTool", related: ["pdf-keppe", "osszeillesztes"], updatedAt: "2026-02-23", launchedAt: "2026-02-23", faq: [] },
  ...
  { slug: "tsv-csv", category: "adat", title: "TSV → CSV konvertáló online | Ingyenes", h1: "TSV → CSV konvertáló", description: "Alakítsd át a tabulátorral elválasztott TSV fájlt vesszővel elválasztott CSV formátumba a böngészőben. Szerverfeltöltés nélkül – ingyenes online konvertáló.", keywords: ["tsv csv", "tsv to csv", "tsv konvertálás", "tab separated csv"], status: "active", component: "DelimiterConvertTool", componentProps: { inputLabel: "TSV fajl", outputLabel: "CSV kimenet", inputAccept: ".tsv,.txt", workerType: "tsv-to-csv", outputExtension: "csv" }, related: ["csv-json", "csv-tsv", "csv-tisztitas"], updatedAt: "2026-02-23", launchedAt: "2026-02-23", faq: [] },
  { slug: "csv-tsv", category: "adat", title: "CSV → TSV konvertáló online | Ingyenes", h1: "CSV → TSV konvertáló", description: "Alakítsd át a CSV fájlt tabulátorral elválasztott TSV formátumba a böngészőben. Szerverfeltöltés nélkül, gyorsan és privát módon – ingyenes online konvertáló.", keywords: ["csv tsv", "csv to tsv", "csv tab konvertálás"], status: "active", component: "DelimiterConvertTool", componentProps: { inputLabel: "CSV fajl", outputLabel: "TSV kimenet", inputAccept: ".csv,.txt", workerType: "csv-to-tsv", outputExtension: "tsv" }, related: ["tsv-csv", "csv-json", "csv-tisztitas"], updatedAt: "2026-02-23", launchedAt: "2026-02-23", faq: [] },
  ...
  { slug: "sorok-szurese", category: "adat", title: "CSV sorok szűrése online | Row filter", h1: "CSV sorok szűrése", description: "Szűrd a CSV sorokat feltétel alapján: tartalmaz, egyenlő, nagyobb, kisebb vagy nem üres. A feldolgozás a böngésződben fut – ingyenes, gyors és privát eszköz.", keywords: ["csv filter", "csv sorok szűrése", "csv row filter online"], status: "active", component: "SorokSzureseTool", related: ["oszlopok-kivalasztasa", "csv-tisztitas"], updatedAt: "2026-02-23", launchedAt: "2026-02-23", faq: [] },
  { slug: "oszlop-szetvalasztas", category: "adat", title: "CSV oszlop szétválasztás online | Column split", h1: "CSV oszlop szétválasztása", description: "Bontsd fel egy CSV oszlop tartalmát több oszlopra elválasztó karakter alapján, automatikus oszlopszám-felismeréssel. A böngészőben fut – ingyenes és privát.", keywords: ["csv split column", "csv oszlop szétválasztás", "csv column split"], status: "active", component: "OszlopSzetvalasztasTool", related: ["csv-tisztitas", "oszlopok-kivalasztasa"], updatedAt: "2026-02-23", launchedAt: "2026-02-23", faq: [] },
  ...
  { slug: "ures-sorok-torlese", category: "szoveg", title: "Üres sorok törlése szövegből | Online eszköz", h1: "Üres sorok törlése", description: "Távolítsd el az üres és csak szóközt tartalmazó sorokat a szövegből egy kattintással. A feldolgozás a böngésződben történik – ingyenes, gyors és privát.", keywords: ["üres sorok törlése", "remove blank lines", "üres sorok eltávolítása", "blank lines remover", "szöveg tisztítás"], status: "active", component: "TextTransformTool", componentProps: { operation: "remove-empty-lines", operationLabel: "Üres sorok törlése", placeholder: "Illeszd be a szöveget – az üres sorok automatikusan törlődnek..." }, related: ["whitespace-tisztitas", "ismetlodok-torlese"], updatedAt: "2026-02-23", launchedAt: "2026-02-23", faq: [] },
  { slug: "whitespace-tisztitas", category: "szoveg", title: "Whitespace tisztítás online | Szóközök normalizálása", h1: "Whitespace tisztítása", description: "Normalizáld a felesleges szóközöket, tabulátorokat és sortöréseket a szövegedben egy kattintással. Tiszta kimenet a böngészőben – ingyenes, gyors és privát.", keywords: ["whitespace", "trim", "whitespace tisztítás", "szóköz eltávolítás", "szöveg trim online"], status: "active", component: "TextTransformTool", componentProps: { operation: "trim-whitespace", operationLabel: "Whitespace tisztítás", placeholder: "Illeszd be a szöveget – a felesleges szóközök normalizálásra kerülnek..." }, related: ["ures-sorok-torlese", "specialis-karakterek-torlese"], updatedAt: "2026-02-23", launchedAt: "2026-02-23", faq: [] },
  ...
  // ═══ SZÖVEG – Batch B (HU+RO, longform) ══════════════════
  {
    slug: "lorem-ipsum", category: "szoveg",
    title: "Lorem Ipsum generátor online – vakszöveg tervezéshez | Ingyenes",
    h1: "Lorem Ipsum generátor",
    description: "Vakszöveg (Lorem Ipsum) generálása bekezdés, mondat vagy szó szerint, tetszőleges mennyiségben. Klasszikus kezdéssel, egy kattintással másolható.",
    keywords: ["lorem ipsum generátor", "vakszöveg", "placeholder szöveg", "lorem ipsum magyar", "dummy text", "kitöltő szöveg"],
    status: "active", component: "LoremIpsumGenerator",
    updatedAt: "2026-07-04", launchedAt: "2026-07-04",
    related: ["szoveg-ismetlo", "szoveg-osszehasonlitas", "slug-generator"], faq: [],
  },
  {
    slug: "szoveg-osszehasonlitas", category: "szoveg",
    title: "Szöveg-összehasonlító online – diff, két szöveg különbsége | Ingyenes",
    h1: "Szöveg-összehasonlító (diff)",
    description: "Két szöveg sor-szintű összehasonlítása: a hozzáadott és törölt sorok színes kiemelése. Szóköz- és kis-/nagybetű-érzéketlen mód. Böngészőben, privát.",
    keywords: ["szöveg összehasonlítás", "text diff", "diff online", "két szöveg különbsége", "szöveg diff magyar", "compare text"],
    status: "active", component: "SzovegOsszehasonlitas",
    updatedAt: "2026-07-04", launchedAt: "2026-07-04",
    related: ["ismetlodok-torlese", "sorok-rendezese", "kereses-csere"], faq: [],
  },
  {
    slug: "szoveg-ismetlo", category: "szoveg",
    title: "Szövegismétlő online – szöveg többszörözése | Ingyenes",
    h1: "Szövegismétlő",
    description: "Szöveg ismétlése tetszőleges alkalommal, választható elválasztóval (új sor, vessző, szóköz) és opcionális sorszámozással. Egy kattintással másolható.",
    keywords: ["szövegismétlő", "text repeater", "szöveg többszörözés", "szöveg ismétlés online", "repeat text", "sor ismétlés"],
    status: "active", component: "SzovegIsmetlo",
    updatedAt: "2026-07-04", launchedAt: "2026-07-04",
    related: ["lorem-ipsum", "vesszo-sortores", "sorok-rendezese"], faq: [],
  },
  {
    slug: "vesszo-sortores", category: "szoveg",
    title: "Vessző ↔ sortörés átalakító online – lista konvertáló | Ingyenes",
    h1: "Vessző ↔ sortörés átalakító",
    description: "Sorokból vesszős lista, vagy vesszős listából sorok – választható elválasztóval, trimmeléssel, duplikátum-szűréssel és idézőjelezéssel. Böngészőben.",
    keywords: ["vessző sortörés", "lista konvertáló", "sorokból lista", "vesszős lista", "comma to lines", "sor vessző átalakító"],
    status: "active", component: "VesszoSortores",
    updatedAt: "2026-07-04", launchedAt: "2026-07-04",
    related: ["szoveg-ismetlo", "ismetlodok-torlese", "whitespace-tisztitas"], faq: [],
  },
  {
    slug: "forditott-szoveg", category: "szoveg",
    title: "Fordított szöveg online – karakter, szó, sor visszafelé | Ingyenes",
    h1: "Fordított szöveg",
    description: "Szöveg megfordítása karakter, szó vagy sor szintjén. Diakritika-helyes (Unicode), egy kattintással másolható. Böngészőben, privát.",
    keywords: ["fordított szöveg", "reverse text", "szöveg visszafelé", "szöveg megfordítás", "tükörszöveg", "backwards text"],
    status: "active", component: "ForditottSzoveg",
    updatedAt: "2026-07-04", launchedAt: "2026-07-04",
    related: ["szoveg-hashtag", "kisbetu-nagybetu", "case-konverter"], faq: [],
  },
  {
    slug: "szoveg-hashtag", category: "szoveg",
    title: "Szöveg → Hashtag generátor online – #hashtag közösségi médiához",
    h1: "Szöveg → Hashtag generátor",
    description: "Szavakból és kifejezésekből hashtagek generálása közösségi médiához – camelCase vagy kisbetűs stílus, ékezet-eltávolítással. Egy kattintással másolható.",
    keywords: ["hashtag generátor", "szöveg hashtag", "hashtag készítő", "instagram hashtag", "camelcase hashtag", "text to hashtag"],
    status: "active", component: "SzovegHashtag",
    updatedAt: "2026-07-04", launchedAt: "2026-07-04",
    related: ["forditott-szoveg", "ekezetek-eltavolitasa", "slug-generator"], faq: [],
  },
  ...
  { slug: "xml-formazas", category: "fejleszto", title: "XML formázó online | Prettify és behúzás", h1: "XML formázása", description: "Formázd és tagold újra az XML kódot olvasható, behúzott szerkezetre a böngészőben. Tiszta kimenet szerverfeltöltés nélkül – ingyenes online beautify eszköz.", keywords: ["xml format", "xml prettify", "xml formázó", "xml beautify online", "xml indent"], status: "active", component: "CodeFormatterTool", componentProps: { mode: "format", language: "xml", placeholder: "Illeszd be az XML kódot..." }, related: ["xml-minimalas", "xml-ellenorzes"], updatedAt: "2026-02-23", launchedAt: "2026-02-23", faq: [] },
  ...
  { slug: "xml-ellenorzes", category: "fejleszto", title: "XML validátor online | Well-formedness", h1: "XML érvényesítése", description: "Ellenőrizd az XML szintaxist és a well-formedness szabályokat DOMParser segítségével a böngészőben. Szerverfeltöltés nélkül – ingyenes, gyors és privát.", keywords: ["xml validate", "xml validátor", "xml ellenőrzés online", "xml well-formed"], status: "active", component: "CodeFormatterTool", related: ["xml-formazas", "yaml-ellenorzes"], updatedAt: "2026-02-23", launchedAt: "2026-02-23", faq: [] },
  ...
  // ═══ MARKDOWN ════════════════════════════════════════════
  { slug: "markdown-html", category: "markdown", title: "Markdown → HTML konvertáló online | Ingyenes", h1: "Markdown → HTML konvertálás", description: "Markdown szöveg HTML-lé alakítása valós idejű előnézettel és nyers HTML kimenettel. Böngészőben, szervermentes.", keywords: ["markdown html", "md to html", "markdown konvertáló", "markdown html online", "md konvertálás"], status: "active", component: "MarkdownHtmlTool", related: ["markdown-megjelenito", "html-szovegge", "html-minimalas-html"], updatedAt: "2026-02-23", launchedAt: "2026-02-23", faq: [] },
  { slug: "markdown-megjelenito", category: "markdown", title: "Markdown megjelenítő online | Élő előnézet | Ingyenes", h1: "Markdown megjelenítő – élő előnézet", description: "Markdown szöveg azonnali előnézete osztott nézetben. CommonMark + GFM (táblázatok, task list, kódblokk). Böngészőben, szervermentes.", keywords: ["markdown megjelenítő", "markdown viewer", "markdown előnézet", "md viewer online", "markdown reader", "markdown render online", "md preview"], status: "active", component: "MarkdownViewerTool", related: ["markdown-html", "html-szovegge", "html-minimalas-html"], updatedAt: "2026-05-02", launchedAt: "2026-05-02", faq: [] },

  // ═══ HTML ════════════════════════════════════════════════
  { slug: "html-szovegge", category: "html", title: "HTML → Szöveg konvertáló online | Tag eltávolítás", h1: "HTML szöveggé alakítása", description: "Távolítsd el a HTML tag-eket, és nyerd ki a tiszta szöveget DOMParser segítségével a böngészőben. Szerverfeltöltés nélkül – ingyenes, gyors és privát.", keywords: ["html to text", "html strip tags", "html szöveggé", "html tag eltávolítás", "html text online"], status: "active", component: "HtmlTextTool", related: ["markdown-html", "html-minimalas-html"], updatedAt: "2026-02-23", launchedAt: "2026-02-23", faq: [] },
  ...
  { slug: "xlsx-json", category: "excel", title: "Excel (XLSX) → JSON konvertáló online | Ingyenes", h1: "Excel → JSON konvertálás", description: "Alakítsd Excel (XLSX) táblázatodat JSON formátumba a böngészőben, munkalap- és fejléc-opciókkal. Szerverfeltöltés nélkül – ingyenes, gyors és privát eszköz.", keywords: ["xlsx json", "excel to json", "excel json konvertálás", "xlsx json online", "excel api adat"], status: "active", component: "XlsxJsonTool", related: ["xlsx-csv", "csv-json", "json-csv"], updatedAt: "2026-02-23", launchedAt: "2026-02-23", faq: [] },
  { slug: "csv-xlsx", category: "excel", title: "CSV → Excel (XLSX) konvertáló online | Ingyenes", h1: "CSV → Excel konvertálás", description: "Alakítsd át CSV fájljaidat Excel (XLSX) formátumba a böngészőben: elválasztó-felismerés és fejléc-kezelés, szerverfeltöltés nélkül. Ingyenes és privát.", keywords: ["csv xlsx", "csv to excel", "csv excel konvertálás", "csv xlsx online", "csv excel konvertáló"], status: "active", component: "CsvXlsxTool", related: ["xlsx-csv", "csv-json"], updatedAt: "2026-02-23", launchedAt: "2026-02-23", faq: [] },
  ...
  // ═══ FÁJL ════════════════════════════════════════════════
  { slug: "zip-keszito", category: "fajl", title: "ZIP fájl készítő online | Ingyenes", h1: "ZIP archívum készítése", description: "Csomagolj több fájlt egyetlen ZIP archívumba a böngészőben: drag & drop feltöltés és méretjelzés, szerverfeltöltés nélkül. Ingyenes és teljesen privát.", keywords: ["zip készítő", "zip creator online", "fájlok zip-be", "zip csomagolás online", "zip archívum készítés"], status: "active", component: "ZipKeszitoTool", related: ["zip-kibonto", "fajl-informacio"], updatedAt: "2026-02-23", launchedAt: "2026-02-23", faq: [] },
  { slug: "zip-kibonto", category: "fajl", title: "ZIP fájl kibontása online | Unzip", h1: "ZIP archívum kibontása", description: "Bontsd ki a ZIP fájlok tartalmát a böngészőben, tartalom-előnézettel és egyenkénti letöltéssel. Semmi nem kerül szerverre – ingyenes, gyors és privát.", keywords: ["unzip online", "zip extract", "zip kibontás", "zip fájl megnyitás online", "zip tartalom"], status: "active", component: "ZipKibontoTool", related: ["zip-keszito", "fajl-informacio"], updatedAt: "2026-02-23", launchedAt: "2026-02-23", faq: [] },
  ...
  { slug: "fajl-informacio", category: "fajl", title: "Fájl információk megjelenítése online | MIME type", h1: "Fájl információk", description: "Nézd meg egy fájl nevét, méretét, típusát, MIME type-ját és módosítási dátumát a böngésződben, a File API segítségével – semmi nem töltődik fel szerverre.", keywords: ["fájl info", "file info", "mime type check", "fájl méret", "fájl típus ellenőrzés"], status: "active", component: "FajlInfoTool", related: ["hash-ellenorzo", "zip-keszito"], updatedAt: "2026-02-23", launchedAt: "2026-02-23", faq: [] },
  ...
  { slug: "procent-calculator",     category: "calculator", title: "Calculator Procente",        h1: "Calculator Procente",        description: "Calculator procente: 4 moduri.",     keywords: [], status: "active", component: "ProcentCalculator",        languages: ["ro"], related: ["medie-aritmetica", "regula-de-trei-simpla", "calculator-tva", "dobanda-compusa"],         updatedAt: "2026-04-25", launchedAt: "2026-04-25", faq: [] },
  ...
  { slug: "medie-aritmetica",       category: "calculator", title: "Calculator Medie",           h1: "Calculator Medie Aritmetică", description: "Medie, mediană, mod, abatere.",      keywords: [], status: "active", component: "MedieCalculator",          languages: ["ro"], related: ["procent-calculator", "medie-admitere-liceu", "regula-de-trei-simpla"],        updatedAt: "2026-04-25", launchedAt: "2026-04-25", faq: [] },
  ...
  { slug: "numere-romane",          category: "calculator", title: "Convertor Numere Romane",    h1: "Convertor Numere Romane ↔ Arabe", description: "Transformă numere romane în arabe și invers (1–3999).", keywords: [], status: "active", component: "NumereRomaneCalculator",   languages: ["ro"], related: ["procent-calculator", "regula-de-trei-simpla"],          updatedAt: "2026-05-31", launchedAt: "2026-05-31", faq: [] },
  { slug: "cmmdc-cmmmc",            category: "calculator", title: "Calculator CMMDC și CMMMC",  h1: "Calculator C.M.M.D.C. și C.M.M.M.C.", description: "Cel mai mare divizor comun și cel mai mic multiplu comun, cu factori primi.", keywords: [], status: "active", component: "CmmdcCmmmcCalculator",     languages: ["ro"], related: ["numere-romane", "regula-de-trei-simpla", "procent-calculator"], updatedAt: "2026-05-31", launchedAt: "2026-05-31", faq: [] },
  { slug: "calculator-fractii",     category: "calculator", title: "Calculator Fracții",         h1: "Calculator Fracții",          description: "Adunare, scădere, înmulțire, împărțire de fracții cu pași și simplificare.", keywords: [], status: "active", component: "FractiiCalculator",        languages: ["ro"], related: ["cmmdc-cmmmc", "procent-calculator", "regula-de-trei-simpla"], updatedAt: "2026-05-31", launchedAt: "2026-05-31", faq: [] },
  { slug: "combinatorica",          category: "calculator", title: "Calculator Combinatorică",   h1: "Calculator Combinatorică",    description: "Factorial, permutări, aranjamente și combinări, cu formule și calcul exact.", keywords: [], status: "active", component: "CombinatoricaCalculator",  languages: ["ro"], related: ["cmmdc-cmmmc", "calculator-fractii", "procent-calculator"], updatedAt: "2026-05-31", launchedAt: "2026-05-31", faq: [] },
  { slug: "progresii",              category: "calculator", title: "Calculator Progresii",       h1: "Calculator Progresii (Șiruri)", description: "Progresii aritmetice și geometrice: termenul de rang n și suma primilor n termeni.", keywords: [], status: "active", component: "ProgresiiCalculator",      languages: ["ro"], related: ["combinatorica", "procent-calculator", "ecuatii-exponentiale"], updatedAt: "2026-05-31", launchedAt: "2026-05-31", faq: [] },
  { slug: "logaritmi",              category: "calculator", title: "Calculator Logaritmi",       h1: "Calculator Logaritmi", description: "Logaritm în orice bază, ln, lg, log₂ și schimbarea de bază, cu proprietăți.", keywords: [], status: "active", component: "LogaritmiCalculator",      languages: ["ro"], related: ["ecuatii-exponentiale", "progresii", "procent-calculator"], updatedAt: "2026-05-31", launchedAt: "2026-05-31", faq: [] },
  { slug: "medie-admitere-liceu",   category: "calculator", title: "Calculator Medie Admitere Liceu 2026", h1: "Calculator Medie Admitere Liceu", description: "Media de admitere la liceu = media notelor de la Evaluarea Națională (română + matematică).", keywords: [], status: "active", component: "MedieAdmitereCalculator", languages: ["ro"], related: ["calculator-medii-note", "medie-bacalaureat", "medie-aritmetica"], updatedAt: "2026-05-31", launchedAt: "2026-05-31", faq: [] },
  { slug: "calculator-medii-note",  category: "calculator", title: "Calculator Medie Note",      h1: "Calculator Medie Note Școlare", description: "Media notelor la o materie și media generală, cu 2 zecimale și varianta rotunjită.", keywords: [], status: "active", component: "MediiNoteCalculator",     languages: ["ro"], related: ["medie-aritmetica", "medie-admitere-liceu", "medie-bacalaureat"], updatedAt: "2026-05-31", launchedAt: "2026-05-31", faq: [] },
  { slug: "medie-bacalaureat",      category: "calculator", title: "Calculator Medie Bacalaureat", h1: "Calculator Medie Bacalaureat", description: "Media la Bacalaureat din probele scrise + verificarea condițiilor de promovare.", keywords: [], status: "active", component: "MedieBacalaureatCalculator", languages: ["ro"], related: ["medie-admitere-liceu", "calculator-medii-note", "bacalaureat-numaratoare"], updatedAt: "2026-05-31", launchedAt: "2026-05-31", faq: [] },
  ...
  { slug: "mile-kilometri",    category: "conversii", title: "Convertor mile ↔ km",           h1: "Convertor mile ↔ km",           description: "Convertor mile ↔ kilometri (1 milă = 1,609344 km).", keywords: [], status: "active", component: "MileKmCalculator",     languages: ["ro"], related: ["km-metri", "km-h-m-s", "cm-metri"], updatedAt: "2026-05-31", launchedAt: "2026-05-31", faq: [] },
  { slug: "km-h-m-s",          category: "conversii", title: "Convertor viteză km/h ↔ m/s",   h1: "Convertor Viteză km/h ↔ m/s",   description: "Convertor viteză: km/h, m/s, mph, noduri.", keywords: [], status: "active", component: "VitezaCalculator",      languages: ["ro"], related: ["mile-kilometri", "km-metri"],        updatedAt: "2026-05-31", launchedAt: "2026-05-31", faq: [] },
  { slug: "octeti",            category: "conversii", title: "Convertor mărime date",         h1: "Convertor Mărime Date (B, KB, MB, GB, TB)", description: "Convertor mărime date: bit, octet, KB, MB, GB, TB (zecimal vs binar).", keywords: [], status: "active", component: "DateMarimeCalculator",   languages: ["ro"], related: ["km-h-m-s", "mile-kilometri"],         updatedAt: "2026-05-31", launchedAt: "2026-05-31", faq: [] },
  ...
  { slug: "pogon-metri-patrati",     category: "conversii", title: "Convertor pogon ↔ m²",           h1: "Convertor Pogon ↔ Metri Pătrați", description: "Pogon în metri pătrați și invers (1 pogon ≈ 5.000 m²). Terenuri agricole RO.", keywords: [], status: "active", component: "PogonCalculator",       languages: ["ro"], related: ["hectare-metri-patrati", "ari-metri-patrati", "jugar-metri-patrati"], updatedAt: "2026-05-31", launchedAt: "2026-05-31", faq: [] },
  { slug: "jugar-metri-patrati",     category: "conversii", title: "Convertor jugăr ↔ m²",           h1: "Convertor Jugăr ↔ Metri Pătrați", description: "Jugăr (iugăr) în m² și hectare (1 jugăr cadastral ≈ 5.755 m²). Variante regionale.", keywords: [], status: "active", component: "JugarCalculator",       languages: ["ro"], related: ["pogon-metri-patrati", "hectare-metri-patrati", "ari-metri-patrati"], updatedAt: "2026-05-31", launchedAt: "2026-05-31", faq: [] },
  ...
  { slug: "calculator-tva",         category: "finante", title: "Calculator TVA România",         h1: "Calculator TVA România",         description: "Calculator TVA cu cotele oficiale RO (19%, 9%, 5%).", keywords: [], status: "active", component: "TvaCalculator",          languages: ["ro"], related: ["calculator-reducere", "marja-adaos", "dobanda-compusa"],            updatedAt: "2026-04-27", launchedAt: "2026-04-27", faq: [] },
  ...
  { slug: "dobanda-compusa",        category: "finante", title: "Calculator Dobândă Compusă",     h1: "Calculator Dobândă Compusă",     description: "Calculator dobândă compusă cu capitalizare lunară/zilnică.", keywords: [], status: "active", component: "DobandaCompusaCalculator", languages: ["ro"], related: ["calculator-credit", "calculator-tva", "marja-adaos"],          updatedAt: "2026-04-27", launchedAt: "2026-04-27", faq: [] },
  ...
  { slug: "puls-zone-antrenament", category: "sanatate", title: "Calculator Puls și Zone",        h1: "Calculator Puls Maxim și Zone de Antrenament", description: "Puls maxim (220−vârstă, Tanaka) și zonele de antrenament prin metoda Karvonen.", keywords: [], status: "active", component: "PulsZoneCalculator",        languages: ["ro"], related: ["calculator-calorii", "calculator-imc"],   updatedAt: "2026-05-31", launchedAt: "2026-05-31", faq: [] },
  ...
  { slug: "1-decembrie-numaratoare", category: "timp", title: "Numărătoare 1 Decembrie",       h1: "Numărătoare Inversă până la 1 Decembrie",  description: "Live countdown până la Ziua Națională a României (1 decembrie) cu confetti tricolor.", keywords: [], status: "active", component: "ZiuaNationalaCountdown",      languages: ["ro"], related: ["craciun-numaratoare", "generator-numaratoare", "diferenta-date"], updatedAt: "2026-05-30", launchedAt: "2026-05-30", faq: [] },
  { slug: "martisor-numaratoare",    category: "timp", title: "Numărătoare Mărțișor",          h1: "Numărătoare Inversă până la Mărțișor",     description: "Live countdown până la Mărțișor (1 martie), simbolul primăverii.",                     keywords: [], status: "active", component: "MartisorCountdown",          languages: ["ro"], related: ["8-martie-numaratoare", "dragobete-numaratoare", "generator-numaratoare"], updatedAt: "2026-05-30", launchedAt: "2026-05-30", faq: [] },
  { slug: "8-martie-numaratoare",    category: "timp", title: "Numărătoare 8 Martie",          h1: "Numărătoare Inversă până la 8 Martie",     description: "Live countdown până la 8 Martie, Ziua Internațională a Femeii.",                       keywords: [], status: "active", component: "ZiuaFemeiiCountdown",         languages: ["ro"], related: ["martisor-numaratoare", "dragobete-numaratoare", "generator-numaratoare"], updatedAt: "2026-05-30", launchedAt: "2026-05-30", faq: [] },
  { slug: "dragobete-numaratoare",   category: "timp", title: "Numărătoare Dragobete",         h1: "Numărătoare Inversă până la Dragobete",    description: "Live countdown până la Dragobete (24 februarie), sărbătoarea iubirii la români.",      keywords: [], status: "active", component: "DragobeteCountdown",         languages: ["ro"], related: ["8-martie-numaratoare", "martisor-numaratoare", "generator-numaratoare"], updatedAt: "2026-05-30", launchedAt: "2026-05-30", faq: [] },
  { slug: "inceput-primavara-numaratoare", category: "timp", title: "Numărătoare Primăvară",   h1: "Numărătoare Inversă până la Primăvară",    description: "Live countdown până la începutul primăverii (echinocțiul de primăvară, ~20 martie).",  keywords: [], status: "active", component: "AnotimpCountdown", componentProps: { nume: "Primăvară", emoji: "🌱", season: "primavara", panaLa: "primăvară" }, languages: ["ro"], related: ["inceput-vara-numaratoare", "martisor-numaratoare", "generator-numaratoare"], updatedAt: "2026-05-31", launchedAt: "2026-05-30", faq: [] },
  { slug: "inceput-vara-numaratoare",      category: "timp", title: "Numărătoare Vară",        h1: "Numărătoare Inversă până la Vară",         description: "Live countdown până la începutul verii (solstițiul de vară, ~21 iunie).",              keywords: [], status: "active", component: "AnotimpCountdown", componentProps: { nume: "Vară", emoji: "☀️", season: "vara", panaLa: "vară" }, languages: ["ro"], related: ["inceput-toamna-numaratoare", "inceput-primavara-numaratoare", "generator-numaratoare"], updatedAt: "2026-05-31", launchedAt: "2026-05-30", faq: [] },
  { slug: "inceput-toamna-numaratoare",    category: "timp", title: "Numărătoare Toamnă",      h1: "Numărătoare Inversă până la Toamnă",       description: "Live countdown până la începutul toamnei (echinocțiul de toamnă, ~22 septembrie).",    keywords: [], status: "active", component: "AnotimpCountdown", componentProps: { nume: "Toamnă", emoji: "🍂", season: "toamna", panaLa: "toamnă" }, languages: ["ro"], related: ["inceput-iarna-numaratoare", "inceput-vara-numaratoare", "generator-numaratoare"], updatedAt: "2026-05-31", launchedAt: "2026-05-30", faq: [] },
  { slug: "inceput-iarna-numaratoare",     category: "timp", title: "Numărătoare Iarnă",       h1: "Numărătoare Inversă până la Iarnă",        description: "Live countdown până la începutul iernii (solstițiul de iarnă, ~21 decembrie).",        keywords: [], status: "active", component: "AnotimpCountdown", componentProps: { nume: "Iarnă", emoji: "❄️", season: "iarna", panaLa: "iarnă" }, languages: ["ro"], related: ["inceput-primavara-numaratoare", "craciun-numaratoare", "generator-numaratoare"], updatedAt: "2026-05-31", launchedAt: "2026-05-30", faq: [] },
