...
const rawTools: Tool[] = [
  ...
  { slug: "generator-cod-bare", category: "fejleszto", title: "Generator Cod de Bare", h1: "Generator Cod de Bare", description: "Generator coduri de bare EAN-13, CODE-128, UPC-A, ITF-14 cu export SVG și PNG.", keywords: [], status: "active", component: "CodBareGenerator", languages: ["ro"], related: ["generator-cod-qr", "base64-kodolo-dekodolo", "url-kodolo-dekodolo"], updatedAt: "2026-04-28", launchedAt: "2026-04-28", faq: [] },
  { slug: "generator-cod-qr",   category: "fejleszto", title: "Generator Cod QR cu Pictogramă", h1: "Generator Cod QR cu Pictogramă", description: "Generator coduri QR cu pictogramă centrală — galerie presetări sau încărcare imagine. Export PNG + SVG.", keywords: [], status: "active", component: "CodQrGenerator",   languages: ["ro"], related: ["generator-cod-bare", "url-kodolo-dekodolo", "base64-kodolo-dekodolo"], updatedAt: "2026-04-28", launchedAt: "2026-04-28", faq: [] },
