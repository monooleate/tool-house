<script lang="ts">
  ...
  const COMPONENT_IMPORTS: Record<string, () => Promise<any>> = {
    ...
    MetaTagGenerator: () => import("../tools/seo/MetaTagGenerator.svelte"),
    OpenGraphGenerator: () => import("../tools/seo/OpenGraphGenerator.svelte"),
    TwitterCardGenerator: () => import("../tools/seo/TwitterCardGenerator.svelte"),
    FaqSchemaGenerator: () => import("../tools/seo/FaqSchemaGenerator.svelte"),
    RobotsTxtGenerator: () => import("../tools/seo/RobotsTxtGenerator.svelte"),
    UtmGenerator: () => import("../tools/seo/UtmGenerator.svelte"),
    UtmEltavolito: () => import("../tools/seo/UtmEltavolito.svelte"),
    UrlNormalizalo: () => import("../tools/seo/UrlNormalizalo.svelte"),
    CanonicalGenerator: () => import("../tools/seo/CanonicalGenerator.svelte"),
    FajlnevOptimalizalo: () => import("../tools/seo/FajlnevOptimalizalo.svelte"),
    RobotsTxtTester: () => import("../tools/seo/RobotsTxtTester.svelte"),
    SitemapChecker: () => import("../tools/seo/SitemapChecker.svelte"),
    AltSzovegGenerator: () => import("../tools/seo/AltSzovegGenerator.svelte"),
    // CONVERSII (RO-only)
    ...
    PogonCalculator:             () => import("../tools/conversii/PogonCalculator.svelte"),
    JugarCalculator:             () => import("../tools/conversii/JugarCalculator.svelte"),
